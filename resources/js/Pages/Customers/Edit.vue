...
const fetchAddress = () => {
    new YubinBangoCore(String(form.postcode), (value) => {
        // console.log(value);
        form.address = value.region + value.locality
    })
}
                        ...
                        <section class="text-gray-600 body-font relative">
                            ...
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea type="text" id="address" name="address" v-model="form.address" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">၊</textarea>
                                </div>
                                </div>
                                <div class="p-2 w-full">
                                    <div class="relative">
                                ...
                                <div class="p-2 w-full">
                                    <div class="relative">
                                        ...
                                        <input type="radio" id="gender0" name="gender" v-model="form.gender" value="0" checked class="ml-4 mr-1">
                                        <label for="gender0" class="leading-7 text-sm text-gray-600">男性</label>
                                        <input type="radio" id="gender1" name="gender" v-model="form.gender" value="1" class="ml-4 mr-1">
                                        <label for="gender1" class="leading-7 text-sm text-gray-600">女性</label>
                                        <input type="radio" id="gender2" name="gender" v-model="form.gender" value="2" class="ml-4 mr-1">
                                ...
                                <div class="p-2 w-full">
                                <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-300 hover:text-black rounded text-lg">更新する</button>
                                </div>
